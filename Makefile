...
sample_profiler:
	...
	$(SAMPLE_PROFILE_SETTINGS) SampleProfilerApplication 100000
	$(SAMPLE_HEAP_STATS_SETTINGS) SampleProfilerApplication 100000
	ls -al *.jfr

my_profiler:
	javac MyProfiler.java
	$(MY_PROFILE_SETTINGS) MyProfiler 100000
	$(MY_HEAP_STATS_SETTINGS) MyProfiler 100000
